...
assert((6028896) % 16 === 0, 'heap must start aligned to 16 bytes, DYNAMIC_BASE==' + 6028896);
...
var HEAPF64 = new Float64Array(buffer);
  ...
  HEAP32[DYNAMICTOP_PTR>>2] = 6028896;
...
// {{PRE_LIBRARY}}
  ...
  var _fetch_work_queue=785984;function __emscripten_get_fetch_work_queue() {
...
env['table'] = new WebAssembly.Table({ 'initial': 2861
  , 'maximum': 2861
  , 'element': 'anyfunc' });
